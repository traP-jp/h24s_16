...
Revision ID: 845a4e8dbfa2
Revises: 
Create Date: 2024-06-16 03:43:03.434387
...
def upgrade() -> None:
    ...
    sa.Column('remind_channel_id', sa.String(length=256), nullable=True),
    sa.Column('periodic_remind_at', sa.String(length=256), nullable=True),
