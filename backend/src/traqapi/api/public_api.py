...
class PublicApi:
    ...
    def get_public_user_icon(
        self,
        username: Annotated[str, Field(strict=True, description="ユーザー名")],
        ...
        _param = self._get_public_user_icon_serialize(
            username=username,
    ...
    @validate_call
    def get_public_user_icon_with_http_info(
        self,
        username: Annotated[str, Field(strict=True, description="ユーザー名")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_public_user_icon_without_preload_content(
        self,
        username: Annotated[str, Field(strict=True, description="ユーザー名")],
        _request_timeout: Union[
            None,
    ...
    def _get_public_user_icon_serialize(
        self,
        username,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/public/icon/{username}',
