...
class FileInfoThumbnail(BaseModel):
    ...
    width: Optional[StrictInt] = Field(default=None, description="サムネイル幅")
    height: Optional[StrictInt] = Field(default=None, description="サムネイル高さ")
    __properties: ClassVar[List[str]] = ["mime", "width", "height"]
