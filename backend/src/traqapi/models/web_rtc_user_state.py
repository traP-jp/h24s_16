...
class WebRTCUserState(BaseModel):
    ...
    sessions: List[WebRTCUserStateSessionsInner] = Field(description="セッションの配列")
    __properties: ClassVar[List[str]] = ["userId", "channelId", "sessions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sessions": [WebRTCUserStateSessionsInner.from_dict(_item) for _item in obj["sessions"]] if obj.get("sessions") is not None else None
        })
        return _obj
