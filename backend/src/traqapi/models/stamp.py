...
class Stamp(BaseModel):
    ...
    __properties = ["id", "name", "creatorId", "createdAt", "updatedAt", "fileId", "isUnicode"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Stamp:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Stamp:
        """Create an instance of Stamp from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Stamp.parse_obj(obj)

        _obj = Stamp.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
