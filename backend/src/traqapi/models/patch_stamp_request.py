...
class PatchStampRequest(BaseModel):
    ...
    スタンプ情報変更リクエスト
    """ # noqa: E501
    name: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="スタンプ名")
    creator_id: Optional[StrictStr] = Field(default=None, description="作成者UUID", alias="creatorId")
    __properties: ClassVar[List[str]] = ["name", "creatorId"]
