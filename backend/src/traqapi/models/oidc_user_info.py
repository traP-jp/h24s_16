...
class OIDCUserInfo(BaseModel):
    ...
    preferred_username: Annotated[str, Field(strict=True)] = Field(description="ユーザー名")
    picture: StrictStr = Field(description="アイコン画像URL")
    updated_at: Optional[StrictInt] = Field(default=None, description="更新日時")
    traq: Optional[OIDCTraqUserInfo] = None
    __properties: ClassVar[List[str]] = ["sub", "name", "preferred_username", "picture", "updated_at", "traq"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "traq": OIDCTraqUserInfo.from_dict(obj["traq"]) if obj.get("traq") is not None else None
        })
        return _obj
